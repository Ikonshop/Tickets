...
export const FetchCandyMachine: FC = () => {
  ...
  const [candyMachineAddress, setCandyMachineAddress] = useState(
    "AYojeY24i4SXE82jZWZHsMsUD29mHg2zzBZWuETCdqti"
  );
    ...
    <div>
      ...
      {wallet.publicKey && ticketsInPocket?.length < 1 && (
        <div className="text-gray-500 no_wallet">
          ...
          <br />
          <br />
          <h1 className="text-2xl font-bold">Oops! no tickets found</h1>
          <img src="/no_wallet.gif" className="cat" />
          <p className="text-gray-500">Buy some tickets, it echoes in here.</p>
        </div>
      )}
